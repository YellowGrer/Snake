...
char choT[2][30][100] = { {"开始游戏", "游戏设置", "操作提示", "当前最高得分："}, {"每格移动时间", "物品生成时间", "物品存在时间", "版本：1.2.2"} }; //显示选项用
char tipT[4][30][100] = { {"在主页操作时：", "空格", "以确认选择", "W", "以切换上一个选项", "S","以切换下一个选项", "Esc", "以关闭游戏"},
	...
	{"在设置页操作时：", "W", "以切换上一个选项", "S", "以切换下一个选项", "Esc","以返回主页"} };
